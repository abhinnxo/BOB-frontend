    ...
    <div>
      <div className="point__controls d-flex justify-content-between">
        <div >
          ...
          <div> <img src={PauseTimer} alt="pause timer" /></div>
        </div>
        <div>
          <div><img src={EndGame} alt="end game" /></div>
          <div className="point__round" >
            <img src={Round} alt="round number" />
            <h1>Round 1</h1>
            </div>
          <div><img src={NextRound} alt="next round" /></div>
        </div>
      </div>
        <div className="point__board text-center">
        <h3>Guess - <span>2</span></h3>
        ...
        <div><ImageInput text="Type a clue..." /></div>
        <input
              type="button"
              name="button"
              value="SEND"
